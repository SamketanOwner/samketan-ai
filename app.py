...
# --- 1. NEW: IMPORT KEY FROM YOUR SEPARATE FILE ---
try:
...
if st.button("🚀 Generate 10 Pro Leads"):
    if not api_key:
        st.error("❌ API Key not found. Please add your key to the keys.py file in GitHub.")
        ...
        try:
            ...
            with st.spinner("🔍 Mining 10 leads..."):
                ...
                # --- PROCESSING TABLE FOR CLICKABLE LINKS ---

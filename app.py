...
# --- 2. THE 4 QUESTIONS (Restored exact wording) ---
...
if st.button("🚀 Generate 10 Pro Leads"):
    if not api_key:
        ...
        try:
            # CONNECTION FIX: Forces the stable version
                ...
                for i, line in enumerate(lines):
                    if '|' in line and '---' not in line:
                        ...
                        if i == 0 or "Agency Name" in line: # Header
                            ...
                            # RESTORED WHATSAPP MESSAGE (Yesterday's Morning Version)

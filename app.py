...
with st.sidebar:
    ...
    st.markdown("---")
    st.info("💡 Tip: Use your full company name for better AI messaging.")
...
if st.button("🚀 Generate 10 Pro Leads"):
    if not api_key:
        ...
        try:
            ...
            # --- THE 404 FIX ---
            # 'gemini-1.5-flash' is now 'gemini-3-flash' in the 2026 stable API
            ...
            with st.spinner("🔍 Mining 10 leads with deep contact info..."):
                ...
                # --- PROCESSING THE TABLE (RECALLING THE PATTERN) ---
